    ...
    <div  class="bg-light p-3 mb-3" > 
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">हाल सम्म सहभागी प्रतियोगिताहरु थप गर्नुहोस</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <form id="playersport-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('playersport.store') }}" method="post">
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="playerid">खेलाडीको नाम छान्नुहोस् <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-playerid-holder" class=" ">
                                                ...
                                                <?php 
                                                    ...
                                                    $selected = Html::get_field_selected('playerid', $value, "");
                                                ?>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="sportsid">खेलको नाम छ्न्नुहोस <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
