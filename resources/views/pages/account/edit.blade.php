                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-telephone-holder" class=" ">
                                            <input id="ctrl-telephone" data-field="telephone"  value="<?php  echo $data['telephone']; ?>" type="text" placeholder="Enter Telephone"  required="" name="telephone"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
