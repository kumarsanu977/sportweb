...
<?php
    ...
    $pageTitle = "Player Achievement Details"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Player Achievement Details</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div  class=" page-content" >
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            ...
                            <div class="page-data">
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Prizeid</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['prizeid'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="bg-light mb-1 card-1 p-2 border rounded">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <small class="text-muted">Sportid</small>
                                                <div class="fw-bold">
                                ...
                                <div class="col-12">
                                    <div class="bg-light mb-1 card-1 p-2 border rounded">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <small class="text-muted">Medal</small>
                                                <div class="fw-bold">
                                                    <?php echo  $data['medal'] ; ?>
                                                </div>
                                            </div>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <a class="btn btn-sm btn-success has-tooltip "   title="Edit" href="<?php print_link("playerachievements/edit/$rec_id"); ?>" >
                                <i class="material-icons">edit</i> Edit
                            </a>
                            <?php } ?>
                            <?php if($can_delete_record){ ?>
                            <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" title="Delete" href="<?php print_link("playerachievements/delete/$rec_id?redirect=playerachievements"); ?>" >
