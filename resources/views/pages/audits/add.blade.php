                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-user_type-holder" class=" ">
                                                <input id="ctrl-user_type" data-field="user_type"  value="<?php echo get_value('user_type', "NULL") ?>" type="text" placeholder="Enter User Type"  name="user_type"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-user_id-holder" class=" ">
                                                <input id="ctrl-user_id" data-field="user_id"  value="<?php echo get_value('user_id', "NULL") ?>" type="number" placeholder="Enter User Id" step="any"  name="user_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-ip_address-holder" class=" ">
                                                <input id="ctrl-ip_address" data-field="ip_address"  value="<?php echo get_value('ip_address', "NULL") ?>" type="text" placeholder="Enter Ip Address"  name="ip_address"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-user_agent-holder" class=" ">
                                                <input id="ctrl-user_agent" data-field="user_agent"  value="<?php echo get_value('user_agent', "NULL") ?>" type="text" placeholder="Enter User Agent"  name="user_agent"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-tags-holder" class=" ">
                                                <input id="ctrl-tags" data-field="tags"  value="<?php echo get_value('tags', "NULL") ?>" type="text" placeholder="Enter Tags"  name="tags"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
