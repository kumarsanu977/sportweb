                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-telephone" > Telephone</th>
                                        <th class="td-profile" > Profile</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class=" td-checkbox">
                                            <label class="form-check-label">
                                            <input class="optioncheck form-check-input" name="optioncheck[]" value="<?php echo $data['uid'] ?>" type="checkbox" />
                                            </label>
                                        </td>
                                        <?php } ?>
                                        <!--PageComponentStart-->
                                        <td class="td-uid">
                                            <a href="<?php print_link("/users/view/$data[uid]") ?>"><?php echo $data['uid']; ?></a>
                                        </td>
                                        <td class="td-name">
                                            <?php echo  $data['name'] ; ?>
                                        </td>
                                        ...
                                        <td class="td-telephone">
                                            <a href="<?php print_link("tel:$data[telephone]") ?>"><?php echo $data['telephone']; ?></a>
                                        </td>
                                        <td class="td-profile">
                                            <?php 
                                                Html :: page_img($data['profile'], '50px', '50px', "small", 1); 
                                            ?>
                                        </td>
