...
class PlayerAchievementsController extends Controller
{
	...
	function index(Request $request, $fieldname = null , $fieldvalue = null){
		...
		$query->join("player", "player_achievements.playerid", "=", "player.PlayerID");
		$query->join("sports", "player_achievements.sportid", "=", "sports.sportsid");
	...
	function store(PlayerAchievementsAddRequest $request){
		...
		if( array_key_exists("certificate", $modeldata) ){
			//move uploaded file from temp directory to destination directory
			$fileInfo = $this->moveUploadedFiles($modeldata['certificate'], "certificate");
			$modeldata['certificate'] = $fileInfo['filepath'];
		}
